"""Request a read-only Codex review for a Codex-admitted experiment."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Request a read-only Codex experiment review")
