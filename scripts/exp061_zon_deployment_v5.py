...
import os as _exp061_os  # v5: rerun-aware deadline and scratch-root selection
...
EXP061_VISIBLE_HARD_STOP_SECONDS = 7200.0
EXP061_RERUN_HARD_STOP_SECONDS = 30600.0
...
def run_exp061_zon_deployment(g: dict) -> dict:
    ...
    # v5 fix #2: the disk-backed view cache must NOT live under WORKING_DIR (see
