...
_expected_effective = {
    ...
    "motion_ema_reset_alpha": (MOTION_RELINK_EMA_RESET_ALPHA, 1.0),
    "motion_ema_innovation_threshold": (MOTION_RELINK_EMA_INNOVATION_THRESHOLD, 1.0),
}
...
_inference_receipt = {
    ...
    "change": "motion_relink_adaptive_ema_reset_only",
...
print("Candidate inference integrity PASS: label-free adaptive EMA reset and actual epoch-2 checkpoint")
