...
EXPERIMENT = "repro_038_public_0941_exact_copy"
PROTOCOL = "public_0941_unmodified_upstream_train4_lb_probe_v1"
NOTEBOOK_SHA256 = "24253cae5a958b83d69e201719388031f5758080c5d01ca1a8e374f3a8225389"
...
def collect(root: Path) -> dict:
    ...
    if hashlib.sha256((root / record["snapshot_source"]).read_bytes()).hexdigest() != NOTEBOOK_SHA256:
        raise ControllerError("Public source is not byte-identical")
