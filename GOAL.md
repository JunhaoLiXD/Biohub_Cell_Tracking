...
- **Phase:** EXP062_K1_CONTROL_RUNNING
...
- **Next action:** exp_062 k1 (CONTROL) is RUNNING on lingxd/biohub-exp062-mutual-best version 1, launched 2026-09-24T04:57:55Z through the controller after a fresh Codex ADMISSION PASS and a passed snapshot smoke. 3.0 GPU h reserved. DO NOT POLL -- wait for the user's completion notice, then collect ONCE. The control must reproduce parent SHA d34533806b3153ddd4f33f3bbc1dea70af2d5406bb1ea48e42c135a97c213f60; if it does not, the insertion is not inert and the arc STOPS there -- do not push the candidate. If it does, push version 2 (CANDIDATE, mutual_best beta=0.20) to the SAME slug, collect it, and only then consider ONE separately authorized LB submission -- and none at all if the candidate output is byte-identical to the control. Project cap three per America/New_York day. Competition closes 2026-09-29 23:59.
